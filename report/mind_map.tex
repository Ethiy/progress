  ...
  \begin{tikzpicture}
    ...
    \path[mindmap, concept color=black!50, text=white]
      ...
      child[concept color=orange, text=black, grow=180]
      {
      	...
      	child[concept color=blue!70!yellow, text=black, grow=270]
      	{
      	...
      	child[concept color=blue!70!yellow, text=black, grow=210]
      	{
      	...
      	child[concept color=blue!70!yellow, text=black, grow=150]
      	{
      	...
      	child[concept color=blue!70!yellow, text=black, grow=90]
      	{
      ...
      child[concept color=blue, text=black, grow=0]{
      	...
      	child[concept color=red, grow=30]{
      		...
      		child[concept color=purple, text=black, grow=90]
      		{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=180]
      			{
      				node[concept]{Over Segmentation}
      				child[concept color=purple!50, text=white, grow=150]
      				{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=120]
      			{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=0]
      			{
      				node[concept]{Inprecise Segmentation}
      				child[concept color=purple!50, text=white, grow=30]
      				{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=60]
      			{
      				node[concept]{Slope}
      				child[concept color=yellow, text=black, grow=60]
      				{
      		...
      		child[concept color=purple, text=black, grow=300]
      		{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=300]
      			{
      				node[concept]{Under Segmentation}
      			...
      			child[concept color=blue!70!yellow, text=black, grow=0]
      			{
      				...
      				child[concept color=purple!50, text=white, grow=330]
      				{
      			...
      			child[concept color=blue!70!yellow, text=black, grow=240]
      			{
      				node[concept]{Height}
      				child[concept color=yellow, text=black, grow=270]
      				{
      ...
      \path (input.west) + (-15, 3) node[circle, fill, color=blue!70!yellow, minimum size=1.5cm, anchor=east] (3) {};
      \path (3.east) + (1.5, 0) node[text=black] {Errors: level $2$};
      \path (input.west) + (-15, 0) node[circle, fill, color=purple!50, minimum size=1.25cm, anchor=east] (4) {};
      \path (input.west) + (-15, -.5) node[circle, fill, color=yellow!80!black, minimum size=1cm, anchor=east] (5) {};
