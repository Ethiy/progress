...
\begin{document}
  \begin{tikzpicture}
    ...
    \path[mindmap, concept color=black!50, text=white]
      node[concept, minimum size=5cm]{\LARGE\textsc{Input}}[clockwise from=0]
      child[concept color=orange, text=black, grow=180]
      {
      	node[concept]{\textsc{Unqualified Building Error}}[clockwise from=180]
      ...
      child[concept color=blue, text=black, grow=0]{
      	node[concept]{\textsc{Qualifiable Building}}
      	child[concept color=green, grow=270]{
      		node[concept]{\textsc{None}}
      	}
      	child[concept color=red, grow=0]{
      		node[concept]{\large\textsc{Errors}}
      		child[concept color=orange, text=black, grow=90]
      		{
      			...
      			child[concept color=purple!50, text=black, grow=150]
      			{
      				...
      				child[concept color=green!80!black, text=white, grow=150]
      				{
      			...
      			child[concept color=purple!50, text=black, grow=30]
      			{
      				...
      				child[concept color=green!80!black, text=white, grow=30]
      				{
      		...
      		child[concept color=orange, text=black, grow=300]
      		{
      			...
      			{
      				node[concept]{Under Segmentation}
      				child[concept color=blue, text=white, grow=330]
      				{
      					node[concept]{Reconstruction Shortfall}
      				}
      			}
      			child[concept color=purple!50, text=black, grow=270]
      			{
      				...
      				child[concept color=green!80!black, text=white, grow=240]
      				{
      					node[concept]{Building Adjacency}
      					child[concept color=green, text=black, grow=270]
      					{
