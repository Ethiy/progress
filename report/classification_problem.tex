	                    ...
	                    child{
	                        ...
	                        child[choice]{
	                            ...
	                            child{
	                                ...
	                                child[classification, level distance=6ex]{
	                                    node (1nonhiervalcl1) [leaf, color=black!50!green, text=white] {Valid}
	                                }
	                                child[classification, level distance=12ex]{
	                        ...
	                        child[choice]{
	                            ...
	                            child{
	                                ...
	                                child[classification, level distance=6ex]{
	                                    node (1nonhiervalcl2) [leaf, color=black!50!green, text=white] {Valid}
	                                }
	                                child[classification, level distance=12ex]{
	                    ...
	                    child{
	                        ...
	                        child{
	                            ...
	                            child{
	                                ...
	                                child[classification, level distance=6ex]{
	                                    node (2nonhiervalcl1) [leaf, color=black!50!green, text=white] {Valid}
	                                }
	                                child[classification, level distance=12ex]{
	                        ...
	                        child{
	                            ...
	                            child{
	                                ...
	                                child[classification, level distance=6ex]{
	                                    node (2nonhiervalcl2) [leaf, color=black!50!green, text=white] {Valid}
	                                }
	                                child[classification, level distance=12ex]{
