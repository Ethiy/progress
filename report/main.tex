	...
	\begin{figure}[H]
		\begin{tikzpicture}
			...
			\path[mindmap, concept color=red, text=white]
				...
				{
					node[concept]{Unqualified Building}[clockwise from=0]
					child[concept color=yellow, text=black, grow=0]
					{
					...
					child[concept color=yellow, text=black, grow=180]
					{
						node[concept]{Unkown}
					}
				}
				child[concept color=purple!50, text=black, grow=216]
				{
					node[concept]{Dimension temporelle}[clockwise from=216]
				  child[concept color=purple!30, text=black]{ node[concept]{Une date}}
				  child[concept color=purple!30, text=black]{ node[concept]{Plusieurs dates}}
				};
		\end{tikzpicture}
