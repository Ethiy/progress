...
~\\
	...
	\begin{figure}[H]
		\begin{center}
			\subfloat[Unqualified errors]{\label{fig::unqualified}}\includegraphics[width=.4\textwidth]{../images/raster/Unqualified_Errors/changed.png}
			\subfloat[Unqualified errors]{\label{fig::unqualified}}\includegraphics[width=.4\textwidth]{../images/raster/Unqualified_Errors/changed.png}
			\subfloat[Unqualified errors]{\label{fig::unqualified}}\includegraphics[width=.4\textwidth]{../images/raster/Unqualified_Errors/changed.png}
			\caption{\label{fig::error_samples} Samples of errors in the dataset.}
		\end{center}
	\end{figure}
